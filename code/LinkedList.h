...
public:
	...
	// post: the size of the list is returned.
	int size() const;
	
	// post: the sum of all node entries is returned (or 0 if none)
	double sum() const;
	...
	// post: the list now has this entry at the last node position.
